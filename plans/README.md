...
Última atualização: 2026-09-16 (fase 3 em execução — plano 036 DONE)
...
| [`fase-3-site-publico/`](fase-3-site-publico/README.md) | 3 — Site público em português | 🟡 Em andamento | **fatiada em 2026-09-14** em 18 planos, **036–053**. **1/18 DONE:** 036 (`fb117b6`). Execução um plano por vez; o 037 é o próximo. A Q-04 foi respondida e adaptada ao projeto em [`docs/identidade-visual.md`](../docs/identidade-visual.md), fonte única do visual, com os recortes da sabatina `identidade-visual`. A Q-RN02 (ordem dentro do ano em Publicações) foi respondida em 2026-09-14 com a opção (c) e não bloqueia mais nenhum plano |
