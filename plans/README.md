...
| `fase-4-internacionalizacao/` | 4 — Internacionalização | ⬜ Não iniciada — sabatinada em 2026-09-24 ([`CHANGELOG_sabatina_fase-4-i18n.md`](../docs/sabatinas/CHANGELOG_sabatina_fase-4-i18n.md), 12 decisões) | não fatiada |
