...
| [`fase-4-internacionalizacao/`](fase-4-internacionalizacao/README.md) | 4 — Internacionalização | ⬜ Não iniciada — sabatinada em 2026-09-24 ([`CHANGELOG_sabatina_fase-4-i18n.md`](../docs/sabatinas/CHANGELOG_sabatina_fase-4-i18n.md), 12 decisões) e **fatiada** na mesma data | **055–073** (19 planos), todos TODO. As duas questões levantadas no fatiamento foram respondidas na mesma data (Decisões 13 e 14 da sabatina, PRD v0.1.59): texto em português sem campo em inglês recebe `lang="pt-BR"` sem ligar o aviso, e o 071 pode parear o sitemap por `serialize`. Nenhum plano bloqueado |
