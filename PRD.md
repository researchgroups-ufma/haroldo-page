...
| Fase 3 — Site público (PT) | 10/12 | 🟡 Em andamento |
...
- [x] Identidade visual aplicada — tokens, escala tipográfica e classes de movimento no plano **036** (`fb117b6`); componentes de base (`PageHeader`, `PillButton`, `Tag`, `ExternalLink`) no **043** (`dfdc0a3`). **Conferida rota a rota no 053** — nenhuma rota usa os componentes ainda
