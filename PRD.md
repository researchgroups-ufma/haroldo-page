...
| `atuacao[]` | lista de objetos | | ⚠ pendente | `{ cargo, instituicao, periodo }` — criado no redesenho (2026-09-23), timeline da Sobre; **o grupo `en` ainda não o cobre** (item da fase 4) |
...
- [ ] Grupo `en` do `perfil` cobre `atuacao[]` (cargo), no Zod e no Tina, com o teste de paridade — acrescentado em 2026-09-24: o campo nasceu no redesenho sem par em inglês
